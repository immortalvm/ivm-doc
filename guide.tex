...
\newcommand{\SIGXB}     [1]{\op{\hex{0C}}\xspace}
\newcommand{\SIGXS}     [1]{\op{\hex{0D}}\xspace}
\newcommand{\SIGXI}     [1]{\op{\hex{0E}}\xspace}
\newcommand{\LOADB}     [1]{\op{\hex{10}}\xspace}
\newcommand{\LOADS}     [1]{\op{\hex{11}}\xspace}
\newcommand{\LOADI}     [1]{\op{\hex{12}}\xspace}
\newcommand{\LOADL}     [1]{\op{\hex{13}}\xspace}
\newcommand{\STOREB}    [1]{\op{\hex{14}}\xspace}
\newcommand{\STORES}    [1]{\op{\hex{15}}\xspace}
\newcommand{\STOREI}    [1]{\op{\hex{16}}\xspace}
\newcommand{\STOREL}    [1]{\op{\hex{17}}\xspace}
\newcommand{\ALLOCATE}  [1]{\op{\hex{18}}\xspace}
\newcommand{\DEALLOCATE}[1]{\op{\hex{19}}\xspace}
...
\newcommand{\NEWFRAME}  [1]{\op{\hex{30}}\xspace}
\newcommand{\SETPIXEL}  [1]{\op{\hex{31}}\xspace}
\newcommand{\ADDSAMPLE} [1]{\op{\hex{32}}\xspace}
