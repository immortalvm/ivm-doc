...
\item The checksum, $c$, is a 12-bit number (3 digits) that is computed as follows from the sequence number and the program octets on the same line:
  \[ c = \modulo{\left ( \sum_{i=0}^{n-1} (256 s + i + 2) P_i \right )}{4093} \]
