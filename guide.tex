...
\begin{test}
  ...
  \begin{memtable}
    ...
    \end{memcolumn}
  \end{memtable}
  When the machine terminates, the value of $\SP$ should be $\hex{D8}$, and the following elements of $\MEM{}$ should have the indicated values.
  \begin{memtable}
    \begin{memcolumn}
      $\hex{D8}$ & $\hex{FE}$ \\
      $\hex{D9}$ & $\hex{FF}$ \\
