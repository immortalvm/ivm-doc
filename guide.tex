...
\begin{memtable}
  ...
  \end{memcolumn}
\end{memtable}
When the machine terminates, the value of $\TERM$ should be $\T$, the value of $\PC$ should be $\hex{30}$, the value of $\SP$ should be $\hex{F8}$, and the following elements should have the indicated values.
\begin{memtable}
  \begin{memcolumn}
    $\hex{E8}$ & $\hex{F8}$ \\
    $\hex{E9}$ & $\hex{00}$ \\
